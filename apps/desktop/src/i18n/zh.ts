...
export const zh = defineLocale({
  ...
  settings: {
    ...
    about: {
      ...
      channel: '更新通道',
      channelDesc: '选择此安装的更新来源。适用于使用此安装的所有配置文件。',
      channelStable: '稳定版',
      channelStableDesc: '仅发布过的官方版本。推荐大多数用户使用。',
      channelBeta: '测试版 (main)',
      channelBetaDesc: 'main 上的每项更改一发布就获取。适合高级用户。',
      channelPersistOnlyNote: '切换通道只会保存偏好设置——检查更新和安装更新需单独操作。',
      never: '从未',
      justNow: '刚刚',
