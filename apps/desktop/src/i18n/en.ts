...
export const en: Translations = {
  ...
  settings: {
    ...
    about: {
      ...
      channelDesc: 'Choose what this installation updates to. Applies to every profile using this install.',
      channelStable: 'Stable',
      channelStableDesc: 'Published official releases only. Recommended for most users.',
      channelBeta: 'Beta (main)',
      channelBetaDesc: 'Every change from main as soon as it lands. Intended for advanced users.',
      channelPersistOnlyNote: 'Switching the channel only saves the preference — check for updates and apply them separately.',
      never: 'never',
      justNow: 'just now',
