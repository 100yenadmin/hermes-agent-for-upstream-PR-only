...
export const ru = defineLocale({
  ...
  settings: {
    ...
    about: {
      ...
      channelDesc: 'Выберите, на что обновляется эта установка. Применяется ко всем профилям этой установки.',
      channelStable: 'Стабильный',
      channelStableDesc: 'Только опубликованные официальные релизы. Рекомендуется большинству пользователей.',
      channelBeta: 'Бета (main)',
      channelBetaDesc: 'Каждое изменение из main сразу после публикации. Для продвинутых пользователей.',
      channelPersistOnlyNote: 'Смена канала только сохраняет настройку — проверка и установка обновлений выполняются отдельно.',
      never: 'никогда',
      justNow: 'только что',
