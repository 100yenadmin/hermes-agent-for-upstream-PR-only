...
export const ar = defineLocale({
  ...
  notifications: {
    ...
    releaseReadyTitle: 'إصدار Hermes جديد',
    releaseReadyMessage: tag => `${tag || 'إصدار رسمي جديد'} جاهز للتثبيت.`,
  ...
  settings: {
    ...
    about: {
      ...
      releaseUpdateReady: tag => `${tag || 'إصدار Hermes جديد'} جاهز للتثبيت.`,
      ...
      fastTrackDesc: 'احصل على كل تغيير في main فور نشره. مخصص للمستخدمين المتقدمين الذين يقبلون تحديثات أكثر تكرارا.',
      releaseTrackHint: version => `مسار الإصدارات · ${version}`,
      unknownVersion: 'غير معروف',
      branchCommit: (branch, commit) => `${branch} عند ${commit}`,
      channel: 'قناة التحديث',
      channelDesc: 'اختر ما يتم التحديث إليه لهذا التثبيت. ينطبق على كل الملفات التي تستخدم هذا التثبيت.',
      channelStable: 'مستقر',
      channelStableDesc: 'الإصدارات الرسمية المنشورة فقط. موصى به لمعظم المستخدمين.',
      channelBeta: 'بيتا (main)',
      channelBetaDesc: 'كل تغيير في main فور نشره. مخصص للمستخدمين المتقدمين.',
      channelPersistOnlyNote: 'تبديل القناة يحفظ التفضيل فقط — تحقق من التحديثات وطبقها بشكل منفصل.',
      never: 'أبدا',
      justNow: 'الآن',
  ...
  updates: {
    ...
    releaseReadyTitle: 'إصدار Hermes جديد',
    releaseReadyBody: tag => `${tag || 'أحدث إصدار رسمي'} جاهز، مع ملاحظات الإصدار أدناه.`,
    releaseNotesUnavailable: 'ملاحظات الإصدار غير متاحة لهذا الإصدار.',
  ...
  shell: {
    ...
    statusbar: {
      ...
      releasesBehind: count => `${count} إصدار متأخر`,
      release: tag => `الإصدار ${tag}`,
